      ...
      <div className=" text-white absolute  md:w-[50%] top-[55%] md:top-[44%] lg:top-[45%] xl:top-[46%] space-y-2 md:space-y-3 -translate-y-[50%] left-4 md:left-10">
        ...
        <FadeUpNormal delay={0.3}>
          <p className=" text-xs md:text-lg font-medium">
            ...
            student views. Expand effortlessly and connect with eager learners
            worldwide. Don't miss out on shining bright in the educational
            landscape!
          </p>
        </FadeUpNormal>
        <FadeUpNormal delay={0.5}>
          <Button className=" bg-secondary font-medium hover:bg-secondary">
            Work With Us
          </Button>
        </FadeUpNormal>
      </div>
